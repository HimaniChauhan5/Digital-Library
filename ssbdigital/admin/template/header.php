...
<html>
  <head>
    ...
    <title>Administrator Page - DBGI</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        <a href="./home.php" class="logo">
          <span class="logo-mini"><b>DBGI</b></span>
          <span class="logo-lg"><b>DBGI </b>College</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../images/uim.jpg" class="user-image" alt="User Image">
                  
                  <span class="hidden-xs">Administrator Page</span>
                </a>
                <ul class="dropdown-menu">
                  <li class="user-header">
                 <img src="../images/uim.jpg" alt="User Image">
        ...
        <section class="sidebar">
          <div class="user-panel">
            <div class="pull-left image">
              ...
              {
                echo "<img src='../images/uim.jpg' class='img-circle' alt='User Image'>"; 
              }
