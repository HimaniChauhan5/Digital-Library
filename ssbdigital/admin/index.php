        ...
        <div class="login-box-body shadowlogin">
          ...
          <form action="index.php" method="post">
            <div class="form-group has-feedback">
              <input type="text" class="form-control" id="userLogin" name="user" placeholder="admin" required autofocus>
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
              <div id="errUser"></div>
            </div>
            <div class="form-group has-feedback">
              <input type="password" class="form-control" id="passLogin" name="pass" placeholder="123" required>
          ...
          <a href="../index.php" class="btn btn-default">Home</a> </div>
