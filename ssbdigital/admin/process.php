...
if( $_POST['option'] == "add" )
{
	try
	{
		...
		$stmt = $conn->prepare("INSERT INTO BOOKS (BK_TITLE,BK_AUTHOR,BK_GENRE,BK_PUBLISH,BK_LANG,BK_PAGES,BK_SYN) VALUES(?,?,?,?,?,?,?,?) ");
		$stmt->execute(array($btitle,$bauthor,$bgenre,$bpublish,$blang,$bpages,$bsyn));
