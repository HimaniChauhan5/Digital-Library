...
<title>DBGI- <?php echo $titlepage ?></title>
</head>
...
<div id="logo">
  <a href="./admin/" class="btn btn-success btn-flat pull-right">Admin Login <i class="fa fa-sign-in"></i></a>
	<a href="./index.php"><!--<img style="background-color: #fff" src="./images/logossb.png" width="350px" style="padding:10px;" class="img-responsive">-->
    <img src="./images/uim.jpg" width="150px" height="150px" style="margin-top:-20px; margin-bottom:-20px;"/>
    </a>
</div>
<!-- nav bar-->
